...
class _VendorEditUIState extends State<VendorEditUI> {
  ...
  late final TextEditingController expertiseController;
  late final TextEditingController descriptionController;
  late final TextEditingController vendorTypeController;
  ...
  void initState() {
    ...
    expertiseController =
        TextEditingController(text: widget.vendor['expertise']);
    descriptionController =
        TextEditingController(text: widget.vendor['description']);
    vendorTypeController = TextEditingController(
        text: widget.vendor['vendor__type']?['name'] ?? '');
  ...
  void _save() {
    ...
    print("IMAGES++${updatedVendor['images']}");
