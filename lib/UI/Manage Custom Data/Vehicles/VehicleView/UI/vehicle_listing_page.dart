  ...
  Widget build(BuildContext context) {
    return BlocBuilder<VehicleBloc, VehicleState>(
      builder: (context, state) => (
          context.watch<VehicleBloc>().filteredResponse.isEmpty
                      ...
                      Expanded(
                        child: Utils.getSearchBarUI(
                          onChange: (value) => context
                              .read<VehicleBloc>()
                              .add(SearchVehicleEvent(value)),
                          searchController:
                              context.read<VehicleBloc>().searchController,
                        ),
                      ),
                  ...
                  Expanded(
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        final vehicle = context.watch<VehicleBloc>().filteredResponse[index];
                                ...
                                child: InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Utils.getText(
                                      ...
                                      color:
                                          vehicle['vin'].contains("UNASSIGNED")
                                              ? AppC.red
                                              : AppC.text,
                                    ),
                                  ),
              ...
              floatingActionButton: FloatingActionButton.extended(
                onPressed: () {
                  var selectedVehicles =
                      context.read<VehicleBloc>().selectedIds;
                  var vehicleList = context.read<VehicleBloc>().apiResponse;
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => VehicleGroupingUI(
