                            ...
                            children: [
                              ...
                              Utils.getTextFormFieldWithIcon(
                                ...
                                onSuffixTap: () {
                                  ...
                                  if (text.isNotEmpty) {
                                    ...
                                    bloc.addressController.clear(); // Clear after action
                                  }
                                },
                              ...
                              Table(
                                ...
                                children: [
                                  ...
                                  ...context.watch<LocationDataBloc>().filterPage.map((e) => LocationListItem(
                                    model: e,
                                    onEdit: () {
                                    ...
                                    onDelete: () {
                                      ...
                                      AskPermissionDialog.show(
                                        ...
                                        onPositivePressed: () => context.read<LocationDataBloc>().add(DeleteLocationEvent(id: e['id'])),
                                      );
                                    },
                                  )).toList(),
                                ],
