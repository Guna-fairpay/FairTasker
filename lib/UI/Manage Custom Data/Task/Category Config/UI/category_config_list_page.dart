      ...
      builder: (context, state) => Column(
        children: [
          ListView.separated(
              ...
              itemCount:
                  context.watch<CategoryConfigBloc>().filteredResponse.length,
              itemBuilder: (context, index) {
                var item =
                    context.watch<CategoryConfigBloc>().filteredResponse[index];
                return SafeArea(
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Expanded(child: Utils.getText(item['category_name'] ?? '',)),
                        Row(
                          spacing: 5,
                          children: [
                            InkWell(
                              onTap: () => context.read<CategoryConfigBloc>().add(EditCategoryConfigEvent(data: item)),
                            ...
                            InkWell(
                                onTap: () {
                                  ...
                                  onPositivePressed: (){}/*context.read<CategoryConfigBloc>().add(DeleteCategoryConfigEvent(data: item)*/);
                                },
