              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => context.read<EditToDoBloc>().add(EditToDoTimeSensitiveEvent()),
                      child: Row(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Checkbox(
                              ...
                              side: BorderSide(color: AppC.grey, width: 2),
                ...
                CustomVehiclePersonField(
                  ...
                  onSelected: (val) =>
                      context.read<EditToDoBloc>().add(EditToDoVPersonEvent(val)),
