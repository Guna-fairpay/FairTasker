          ...
          if (state.selectedTaskIdentifier.containsKey(3) &&
            ...
            SearchViewField<Map<String, dynamic>>(
                ...
                suggestions: List.from(
                    state.selectedTaskIdentifier[3]['value']['addresses']),
              ...
              children: [
                ...
                if ((state.showCleanCar &&
                        (DateTime.now().compareTo(
                                context.watch<AddToDoBloc>().addToDoDate) ==
                            1)) &&
                ...
                if ((state.showCleanCar &&
                  ...
                  Flexible(
                      child: Utils.dropdownBox(
                          "",
                          List.from(state.clearDurations),
                          initialSelection: state.selectedClearDuration,
                          (selectedValue) => context
                              .read<AddToDoBloc>()
                              .add(AddToDoCleanCarDuration(selectedValue)),
                          labelKey: "value")),
              ],
            ),
            ...
            Row(
              ...
              children: [
                ...
                SuccessButton(
                  ...
                  text: (state.selectedLinkOption?['id'] == 1) ? "Link" : "Reservation",
                  onPressed: () => context.read<AddToDoBloc>().add(AddToDoCustomLinkEnableEvent()),
                )
              ],
            ),
                  ...
                  : Text.rich(
                      TextSpan(
                          ...
                          recognizer: TapGestureRecognizer()
                            ..onTap = () => context
                                .read<AddToDoBloc>()
                                .add(AddToDoOpenCustomLinkEvent())),
