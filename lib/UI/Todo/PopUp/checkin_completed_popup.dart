...
class CheckInCompleteDialog {
  CheckInCompleteDialog._();

  static final CheckInCompleteDialog instance = CheckInCompleteDialog._();

  void show(BuildContext context) async {
    await showDialog(
        context: context,
        barrierDismissible: true,
        builder: (BuildContext context) => DummyView());
  }
}
