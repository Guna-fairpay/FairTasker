              ...
              Expanded(
                  child: Padding(
                    ...
                    ...context
                        ...
                        .map((e) => LogTableRow(
                            model: e,
                            onEdit: () => context.read<LogBloc>().add(LogEditEvent(e)),
                            onAttachment: () => context.read<LogBloc>().add(LogViewAttachmentEvent(e)),
                            onDelete: () => context.read<LogBloc>().add(LogDeletePermissionEvent(e))))
                        .toList()
                                    ],
                                  ),
                  ))
