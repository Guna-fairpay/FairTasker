...
class VehicleHistoryDetailsUiDialog {
  ...
  static void show(BuildContext context,
      {Map<String, dynamic>? mapData, bool showAsDialog = true}) async {
    if (showAsDialog) {
      var bloc = context.read<VehicleHistoryBloc>();
      await showDialog(
          context: context,
          builder: (context) =>
              VehicleHistoryDetailsUi(
                bloc: bloc,
                mapData: mapData ?? {},
              ),
      ...
      context.push(_ViewHistoryDetailsUi(mapData: mapData), fullscreenDialog: true);
    }
  }
}
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ListWidget<Map<String, dynamic>>(
                item: mapData,
                itemAsString: (item) => ("${mapData?['users']?['first_name'] ?? ""} ${mapData?['users']?['last_name'] ?? ""}"),
