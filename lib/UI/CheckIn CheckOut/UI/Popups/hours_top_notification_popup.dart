...
class HoursPopup {
  ...
  static void _showTopNotification(
      ...
      String userName,
      String selectedDateRange, int empID,int hrmID, String fromDate, String toDate,)
  {
    ...
    showGeneralDialog(
      ...
      {
        return
        BlocProvider(create: (context) => WorkingHoursBloc()..add(HoursPopupEvent(
            hrmId: hrmID,
            fromDate: fromDate,
            toDate: toDate,
            dataList: dataList,
            ...
            empID: empID)),
        child: BlocListener<WorkingHoursBloc, WorkingHoursState>(listener: (context, state) {
          if(state.isLoading){
            EasyLoading.show();
          } else {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: state.hoursData1.length,
