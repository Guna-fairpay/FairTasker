            ...
            return Row(
              ...
              children: [
                Container(
                  ...
                  child: Center(
                    child: Utils.getText(
                      <String>[(notes['user']?['first_name'] ?? ""), (notes['user']?['last_name'] ?? "")].toInitial,
                ...
                Column(
                  ...
                  children: [
                    Row(
                      children: [
                        IconButton(color: AppC.appColor, onPressed:()=>context.read<VehicleNotesBloc>().add(UpdateNotesEvent(editData: notes)), icon: const Icon( Icons.edit_outlined),),
                        IconButton(color: AppC.redAccent, onPressed:(){}, icon: const Icon( Icons.delete_outline_sharp),),
                      ],
                    ),
                    Padding(
