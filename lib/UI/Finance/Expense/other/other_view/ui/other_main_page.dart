        ...
        child: BlocListener<OtherViewBloc, OtherViewState>(
            listener: (context, state) {
              if (state is LoadingState) {
                ...
                if (state is AddEditState) context.push(OtherAddEditMainPage(id: state.id,));
                if (state is CategoryDialogState) CategoryDialogUI.show(model: state.model, context: context,);
              }
            },
