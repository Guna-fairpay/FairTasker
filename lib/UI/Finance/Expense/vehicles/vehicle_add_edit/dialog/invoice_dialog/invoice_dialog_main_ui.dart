...
class InvoiceDialogMainUI{
  InvoiceDialogMainUI._();
  ...
  static void show(BuildContext context) async {
    await showDialog(
        ...
        builder: (dialogContext) => BlocProvider.value(
            value: BlocProvider.of<VehicleAddEditBloc>(context),
            child: const _InvoiceDialogMainUI())
    );
  }
}

class _InvoiceDialogMainUI extends StatelessWidget {
  const _InvoiceDialogMainUI();

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<VehicleAddEditBloc, VehicleAddEditState>(
        builder: (context,state) {
          var invoiceData = context.read<VehicleAddEditBloc>().invoiceData;
          return ListView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Table(
                              ...
                              children: [
                                const TableHeaderRow(labels: ["S.NO", "Description", "Qty", "Rate", "Total",], backgroundColor: AppC.appbgColor),
                            ...
                            Row(
                              ...
                              children: [
                                Utils.getElevatedButton(() => context.read<VehicleAddEditBloc>().add(GenerateInvoiceEvent()),text: 'Generate Invoice',icon: Icons.print_outlined),
                              ],
                            ),
                          ],
                        ),
