class ExpensePersonResponse {
  ExpensePersonResponse({
    this.data,
    this.addData,
    this.message,
  ...
  ExpensePersonResponse.fromJson(dynamic json) {
    addData = json['data']is Map<String, dynamic>? [Map<String, dynamic>.from(json['data'] ?? {})]
