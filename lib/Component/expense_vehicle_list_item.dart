...
import '../UI/Finance/Expense/Component/category_subcategory_dialog.dart';
import '../UI/Finance/Expense/Component/cohort_dialog.dart';
import '../UI/Vehicle/vehicle_expense_history/ui/vehicle_expense_history_ui.dart';
import '../UI/dialog/ask_permission_dialog.dart';
                ...
                child: Row(
                  children: [
                    Expanded(
                      ...
                      child: InkWell(
                        onTap: () {
                          CohortDialog.show(context,vehicleName: expense['vehicle']['vehicle_name']);
                        },
                        child: Utils.getText(
                          cohort,
                          overFlow: TextOverflow.ellipsis,
                    ...
                    Expanded(
                      ...
                      child: InkWell(
                        onTap: () {
                          CategorySubcategoryDialog.show(context,vehicleName: expense['vehicle']['vehicle_name']);
                        },
                        child: Utils.getText(
                            ...
                            MaterialPageRoute(
                                builder: (context) => VehicleExpenseHistoryUI(
                                    ...
                                    vehicleName: expense['vehicle']
                                            ['vehicle_name'] ?? '',
                                  currentExpenseAmount:double.tryParse(expense['expense_amount'].toString()) ,
